...
public class PopolaDB {
    ...
    public static void main(String[] args) {
        ...
        catalogo1.aggiungiProdotto("Tesi di laurea", "Un capolavoro accademico dal valore inestimabile, redatto all'ombra della meravigliosa Piazza d'Italia a Sassari, tra il profumo della favata e il fascino senza tempo della Sardegna. Vale ogni singolo centesimo.", 999, Categoria.Giochi, 10, 0);
        ...
        for (Utente utente : users) {
            ...
            List<Prodotto> catalogoMescolato = new ArrayList<>(catalogo);
